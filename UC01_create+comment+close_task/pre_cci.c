# 1 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c"
...
# 1 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
# 2 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
# 4 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
# 5 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
CreateOrder()
{
	...
	lr_end_transaction("UC01_TR03_Location1",2);
	...
	lr_end_transaction("UC01_TR04_theme1",2);
	...
	lr_end_transaction("UC01_TR06_inventoryNum",2);
	...
	lr_end_transaction("UC01_TR08_descFinishOK",2);

	return 0;
}
# 6 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
Comment()
{
	...
	lr_end_transaction("UC03_TR10_selectTask",2);
	...
	lr_end_transaction("UC03_TR11_commentFinish",2);

	lr_think_time(10);

	return 0;
}
# 7 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
Close()
{
	...
	lr_end_transaction("UC04_TR14_ToOrder",2);
	...
	lr_end_transaction("UC04_TR15_closeOrder",2);

	return 0;
}
# 8 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
Logout()
{
	...
	lr_end_transaction("UC01_TR16_logout1",2);
	return 0;
}
# 9 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
...
# 10 "c:\\users\\student\\documents\\\341\340\351\352\356\342\\xdesk lr\\learning2\\uc01_create+comment+close_task\\\\combined_UC01_create+comment+close_task.c" 2
